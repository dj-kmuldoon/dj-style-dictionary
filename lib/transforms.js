...
const directoriesToRemove = ['nk-wsj', 'dj-palette', 'palettes', 'palette', 'Palette', 'alpha', 'Alpha']
...
//
// A list of directories which are helpful for design but
// should be removed for presentation to developers.
//
...
//
// Token organization presented to designers in Figma 
// may not align to the organizational preference of
// developers. 'removeDuplicates()' normalizes the tokens
// for easier developer consumption.
//
...
module.exports = () => {
    ...
    StyleDictionaryPackage.registerTransform({
      ...
      transformer: (prop) => {
        if (prop.filePath.endsWith("dj-semantic.json")) {
  ...
  StyleDictionaryPackage.registerTransform({
    ...
    transformer: (prop) => {
      if (prop.filePath.endsWith("dj-semantic.json")) {
        ...
        var index = prop.path.indexOf("color");
        prop.path[index] = "palette";
